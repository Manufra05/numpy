...
template <typename T> static void simd_unary_loop_absolute(T* op, const T* ip, npy_intp len) {
    execute_simd_unrolled_loop(op, ip, len, [](T v) { return std::abs(v); }, [](auto d, auto v) { return hn::Abs(v); });
}

template <typename T> static void simd_unary_loop_square(T* op, const T* ip, npy_intp len) {
    execute_simd_unrolled_loop_mul(op, ip, len, [](T v) { return v * v; }, [](auto d, auto v1, auto v2) { return hn::Mul(v1, v2); });
}

template <typename T> static void simd_unary_loop_reciprocal(T* op, const T* ip, npy_intp len) {
    execute_simd_unrolled_loop_div(op, ip, len, [](T v) { return static_cast<T>(1.0) / v; }, [](auto d, auto v1, auto v2) { return hn::Div(v1, v2); });
}

template <typename T> static void simd_unary_loop_sqrt(T* op, const T* ip, npy_intp len) {
    execute_simd_unrolled_loop(op, ip, len, [](T v) { return std::sqrt(v); }, [](auto d, auto v) { return hn::Sqrt(v); });
}

template <typename T> static void simd_unary_loop_floor(T* op, const T* ip, npy_intp len) {
    execute_simd_unrolled_loop(op, ip, len, [](T v) { return std::floor(v); }, [](auto d, auto v) { return hn::Floor(v); });
}

template <typename T> static void simd_unary_loop_ceil(T* op, const T* ip, npy_intp len) {
    execute_simd_unrolled_loop(op, ip, len, [](T v) { return std::ceil(v); }, [](auto d, auto v) { return hn::Ceil(v); });
}

template <typename T> static void simd_unary_loop_trunc(T* op, const T* ip, npy_intp len) {
    execute_simd_unrolled_loop(op, ip, len, [](T v) { return std::trunc(v); }, [](auto d, auto v) { return hn::Trunc(v); });
}

template <typename T> static void simd_unary_loop_rint(T* op, const T* ip, npy_intp len) {
    execute_simd_unrolled_loop(op, ip, len, [](T v) { return std::rint(v); }, [](auto d, auto v) { return hn::Round(v); });
}
